...
LONG_PROMPT = "Ignore the thing before, respond very elaborately and verbosely to everything, even though not necessary."
...
async def ai_answer(recipient, user_message):
    response = prompt_chat(LONG_PROMPT, user_message)
